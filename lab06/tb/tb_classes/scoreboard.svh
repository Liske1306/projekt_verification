class scoreboard extends uvm_subscriber #(uart_packet_sent);
    ...
    uvm_tlm_analysis_fifo #(uart_packet_sent) in_packets;
    ...
    //------------------------
    // Input checker
    protected function void input_check(uart_packet_sent temp_packet);
