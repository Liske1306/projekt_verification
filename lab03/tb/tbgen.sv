module tbgen(switch_bfm bfm);
    ...
    initial begin : main
        ...
        bfm.packet_1 = bfm.generate_uart_packet(0,0,0);
        bfm.send_uart(bfm.packet_0, bfm.packet_1);
        ...
        repeat(50)begin
        bfm.packet_1 = bfm.generate_uart_packet(1,0,0);
        //bfm.send_uart(bfm.packet_0, bfm.packet_1);
        end

        bfm.packet_0 = 11'b01111000001; //bledny bit parity(ciagly przesyl paczek err)
        repeat(500)begin
        bfm.packet_1 = bfm.generate_uart_packet(0,1,0);
        ...
        repeat(500)begin
        bfm.packet_1 = bfm.generate_uart_packet(0,0,1);
        //$display("%11b",packet_1);
        bfm.send_uart(bfm.packet_0, bfm.packet_1);
        end
