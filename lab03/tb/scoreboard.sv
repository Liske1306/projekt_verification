module scoreboard(switch_bfm bfm);
    ...
    uart_packet_sent input_packets[$]; //queue of found input packets
    uart_packet_sent output_packets[$]; //queue of found output packets
